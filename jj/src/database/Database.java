...
import coreClasses.ItemAvailableState;
import coreClasses.ItemAwaitingCheckinState;
import coreClasses.ItemAwaitingPackerState;
import coreClasses.ItemAwaitingPickerState;
import coreClasses.ItemAwaitingStockerState;
import coreClasses.ItemPackedState;
import coreClasses.ItemPendingStockingState;
import coreClasses.ItemShippedState;
...
public class Database implements I_Database {
	...
	private Database() throws Exception
	{
		...
		items.get(0).setCurrentState(new ItemAwaitingStockerState());
		items.get(1).setCurrentState(new ItemAwaitingStockerState());
		
		items.get(2).setCurrentState(new ItemPendingStockingState());
		items.get(3).setCurrentState(new ItemPendingStockingState());
		...
		items.get(4).setCurrentState(new ItemAvailableState());
		items.get(5).setCurrentState(new ItemAvailableState());
		
		items.get(6).setCurrentState(new ItemAwaitingPickerState());
		items.get(7).setCurrentState(new ItemAwaitingPickerState());
		
		items.get(8).setCurrentState(new ItemAwaitingCheckinState());
		items.get(9).setCurrentState(new ItemAwaitingCheckinState());
		...
		items.get(10).setCurrentState(new ItemAwaitingPackerState());
		items.get(11).setCurrentState(new ItemAwaitingPackerState());
		items.get(12).setCurrentState(new ItemPackedState());
		items.get(13).setCurrentState(new ItemPackedState());
		items.get(14).setCurrentState(new ItemShippedState());
		items.get(15).setCurrentState(new ItemShippedState());
