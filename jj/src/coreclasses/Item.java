...
public class Item{
	...
	private I_ItemState i_ItemState;
	...
	public Item(int productID, int id, String manufactureDate, String expriryDate) throws Exception
	{
		...
		this.i_ItemState = new ItemAwaitingStockerState();
	...
	public void setCurrentState(I_ItemState i_ItemState)
	{
		 this.i_ItemState = i_ItemState;
	}
	
	public I_ItemState getCurrentState()
	{
		return this.i_ItemState;
	}
