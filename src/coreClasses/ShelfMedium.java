...
public class ShelfMedium extends ShelfDecorator{

	public ShelfMedium(I_Shelf i_Shelf) {
		super(i_Shelf);
	}

	@Override
	public int getHeight() {
		return i_Shelf.getHeight() + 50;
	}
	@Override
	public int getWidth() {
		return i_Shelf.getWidth() + 100;
	}
	@Override
	public int getDepth() {
		return i_Shelf.getDepth() + 40;
	}
